...
const HORIZONS_OVERRIDES = {
  ...
  "65": {
    "response": 0,
    "justification": "Position intermédiaire : Édouard Philippe propose simultanément de relancer le nucléaire et de développer les renouvelables. Le parti ne soutient donc pas l'arbitrage précis de Q65 consistant à réduire certains investissements renouvelables au profit du nucléaire ; 0 est plus juste que +1.",
    "source": "https://www.edouardphilippe.fr/priorites/pour-une-france-plus-conquerante"
  },
  "66": {
  ...
  "73": {
    "justification": "Accord très fort : Édouard Philippe lie explicitement le séjour durable et l'intégration à la maîtrise du français, au travail et au respect des valeurs républicaines. La condition d'efforts concrets formulée par Q73 correspond directement à sa ligne ; +3 reste justifié.",
    "source": "https://www.edouardphilippe.fr/priorites/pour-une-france-plus-sure"
  },
  "74": {
  ...
  "80": {
    "justification": "Position intermédiaire : Horizons reconnaît l'objectif de mixité sociale, mais son groupe parlementaire a voté en commission pour supprimer un dispositif qui aurait diminué de 10 à 50 % le financement des établissements privés en fonction d'un indicateur de mixité, notamment parce qu'il ne traitait pas aussi la ségrégation dans le public. Le parti ne rejette donc pas la mixité, mais ne soutient pas la condition financière précise de Q80 ; 0 reste adapté.",
