// Calibration finale de Q75 après reformulation de la question.
// Cette couche est chargée après les autres overrides afin de conserver un codage
// homogène entre partis et gouvernements, toujours résolu par l'ID stable 75.
(() => {
  ...
  const questionIndex = DATA.questions.findIndex(item => item.id === 75);
  ...
  Object.entries(Q75_OVERRIDES).forEach(([entityId, override]) => {
