const QUESTION_DETAILS = {
  ...
  38: {
    ...
    factors: [
      ...
      { title: "Une monnaie commune, une politique commune", text: "Le dollar repose lui aussi sur une banque centrale commune : la Réserve fédérale fixe une politique pour l’ensemble des États-Unis, pas un taux différent pour chaque État. Cela rappelle qu’une monnaie commune implique normalement une politique monétaire commune. Les écarts régionaux sont toutefois davantage amortis aux États-Unis par le budget fédéral et des marchés financiers plus intégrés qu’en zone euro.", sources: ["fed", "risk-sharing"] },
    ...
    sources: [
      ...
      { id: "fed", title: "The Fed Explained — Who We Are", publisher: "Réserve fédérale des États-Unis", year: "consulté en 2026", url: "https://www.federalreserve.gov/aboutthefed/fedexplained/who-we-are.htm", note: "une politique monétaire commune à l’ensemble des États américains" }
    ]
  },
