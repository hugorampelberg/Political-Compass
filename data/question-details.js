const QUESTION_DETAILS = {
  5: {
    ...
    favour: [
      ...
      { title: "Relever aussi certains salaires proches du SMIC.", text: " Le SMIC sert de plancher à de nombreuses grilles de salaires. Lorsqu’il monte, les négociations peuvent relever une partie des rémunérations situées juste au-dessus. Entre 2021 et 2025, le premier quart des salariés, dont les salaires sont les plus proches du SMIC, a connu une progression moyenne voisine de celle du SMIC.", sources: ["experts"] }
    ],
    reserve: [
      { title: "Une forte hausse peut alimenter l’inflation.", text: " Dans les secteurs qui emploient beaucoup de salariés au SMIC, les entreprises peuvent relever leurs prix pour couvrir une partie du surcoût. Une étude sur les restaurants français constate que les hausses du salaire minimum se transmettent progressivement aux prix pendant plus d’un an. Si ce mécanisme touche de nombreux secteurs, il contribue à l’inflation et absorbe une partie du gain de pouvoir d’achat. L’étude ne mesure toutefois pas l’effet sur l’ensemble des prix en France, qui dépend aussi des marges, de la productivité et de la demande.", sources: ["prices", "experts"] },
      ...
      { title: "Le SMIC est déjà proche du salaire médian en France.", text: " En 2024, il représentait 62,5 % du salaire médian, le niveau le plus élevé parmi les pays européens comparés par le groupe d’experts. Une hausse supplémentaire peut donc toucher davantage de salariés et rapprocher un plus grand nombre de rémunérations du minimum.", sources: ["experts"] }
    ],
    factors: [
      ...
      { title: "Aides aux entreprises", text: "Les allègements de cotisations protègent l’emploi près du SMIC, mais leur coût atteignait près de 80 milliards d’euros en 2024 sur l’ensemble des salaires concernés. Une hausse du SMIC peut augmenter cette dépense si la protection est maintenue, ou alourdir le coût pour l’employeur si elle ne l’est pas.", sources: ["experts"] },
    ...
    sources: [
      ...
      { id: "experts", title: "Groupe d’experts sur le SMIC — rapport 2025", publisher: "Haut-commissariat à la stratégie et au plan", year: "2025", url: "https://www.strategie-plan.gouv.fr/publications/groupe-dexperts-smic-rapport-2025", note: "pouvoir d’achat, diffusion aux autres salaires, emploi et allègements de cotisations" }
    ]
  },
  ...
  32: {
    ...
    favour: [
      { title: "Réduire les prélèvements sur le travail.", text: " Une baisse des cotisations salariales augmente directement le salaire net. Une baisse des cotisations patronales réduit le coût d’un emploi et peut soutenir les recrutements. Le choix de la cotisation supprimée détermine la part immédiate de chacun de ces deux effets.", sources: ["france"] },
      { title: "Élargir le financement au-delà des seuls salaires.", text: " La TVA est payée par le consommateur final sur la grande majorité des biens et services ainsi que sur la plupart des importations. Les achats financés par une retraite ou des revenus du patrimoine, et la consommation taxée des ménages très riches, participent donc aussi au financement social.", sources: ["vat"] },
    ...
    reserve: [
      ...
      { title: "Une baisse de la consommation peut freiner l’activité à court terme.", text: " Les personnes qui ne bénéficient pas de la baisse des cotisations peuvent réduire leurs achats, ce qui pèse d’abord sur les ventes. Cet effet peut être partiellement compensé par la consommation des salariés mieux rémunérés, par les exportations et par les investissements financés grâce à l’épargne. Une simulation de la Commission européenne pour la France prévoit ainsi une baisse initiale de la consommation, puis un redressement.", sources: ["france", "savings"] }
    ],
    factors: [
      ...
      { title: "Utilisation du revenu", text: "La part dépensée, épargnée ou investie change l’effet sur l’activité et le financement de l’économie. L’assurance-vie peut financer de la dette publique, tandis que le Livret A finance surtout le logement social : tous les placements n’ont pas la même destination.", sources: ["insurance", "livret"] },
      { title: "TVA réellement acquittée", text: "La TVA reste difficile à éviter sur un achat déclaré en France, mais elle n’est pas inévitable : épargner reporte son paiement, certaines opérations sont exonérées et la fraude ou les transactions non déclarées existent.", sources: ["vat", "vatgap"] }
    ],
    ...
    sources: [
      ...
      { id: "insurance", title: "La situation des assureurs en France fin 2025", publisher: "Autorité de contrôle prudentiel et de résolution", year: "2026", url: "https://acpr.banque-france.fr/fr/publications-et-statistiques/publications/ndeg-181-la-situation-des-assureurs-en-france-fin-2025", note: "répartition des placements des assureurs" },
      { id: "livret", title: "À quoi servent les fonds du Livret A ?", publisher: "Ministère de l’Économie et des Finances", year: "mise à jour continue", url: "https://www.economie.gouv.fr/facileco/quoi-servent-les-fonds-du-livret", note: "financement du logement social et placements du fonds d’épargne" }
    ]
  },
  ...
  38: {
    ...
    metaDescription: "Comprendre les avantages et les limites de l’euro et de la BCE pour la France : échanges, taux d’intérêt, stabilité, franc et comparaison avec la Fed.",
    ...
    balance: [
      "Si la France voulait de nouveau une banque centrale décidant seule de sa politique monétaire, elle devrait en pratique retrouver une monnaie nationale. La Banque de France pourrait alors adapter ses taux à la seule économie française et laisser le franc monter ou baisser. En contrepartie, les échanges avec les pays de la zone euro seraient de nouveau soumis aux variations entre monnaies.",
      { text: "Les « taux directeurs » ne sont pas les taux auxquels la BCE prête directement à la France ou aux autres États. Ils encadrent surtout ce que les banques commerciales reçoivent lorsqu’elles placent de l’argent auprès de la BCE, ou paient lorsqu’elles lui en empruntent. Ils influencent ensuite les crédits, l’épargne et les taux des marchés financiers, y compris indirectement le coût des nouveaux emprunts publics.", sources: ["rates", "state-rates"] },
      { text: "Lorsque la BCE relève ses taux, les nouveaux crédits deviennent généralement plus chers et l’épargne plus attractive. Les ménages consomment ou achètent moins à crédit, les entreprises peuvent reporter des investissements et l’activité ralentit : cela aide normalement à faire baisser l’inflation, mais peut peser sur la croissance et l’emploi. Une baisse des taux produit généralement les effets inverses, avec le risque de ranimer l’inflation ou un endettement excessif.", sources: ["rates", "mortgages"] },
      { text: "La BCE choisit sa politique pour maintenir l’inflation autour de 2 % à moyen terme dans l’ensemble de la zone euro. Une réponse commune est cohérente face à un choc commun. Mais si la France ralentit alors que d’autres pays connaissent une forte inflation, le taux adapté à la moyenne peut être trop élevé pour la France ; dans la situation inverse, il peut être trop faible. La France doit alors davantage compter sur son budget, les salaires, les prix, le crédit privé ou les mécanismes européens pour absorber l’écart.", sources: ["asymmetry", "risk-sharing"] },
      { text: "La France ne décide donc plus seule, mais elle n’est pas absente de la décision : le gouverneur de la Banque de France siège au Conseil des gouverneurs de la BCE. Il participe à la définition de la politique monétaire, qui doit toutefois répondre à la situation de toute la zone et non aux seuls besoins français.", sources: ["governing-council"] }
    ],
    favour: [
      { title: "Le risque de change disparaît à l’intérieur de la zone.", text: " Une entreprise française n’a plus à craindre que la monnaie italienne ou allemande change fortement de valeur entre la commande et le paiement. Elle n’a pas non plus à payer pour se protéger contre ce risque.", sources: ["integration"] },
      { title: "Des prix et des échanges plus simples.", text: " La même monnaie facilite les contrats, les voyages et la comparaison des prix. Cela favorise les échanges et l’investissement entre les pays de la zone, sans supprimer leurs différences de règles ou de productivité.", sources: ["integration"] },
      { title: "Le poids d’une grande monnaie.", text: " L’euro donne accès à un marché financier plus vaste et possède une place internationale que le franc aurait probablement davantage de mal à atteindre. Une monnaie nationale pourrait rester crédible, mais elle pèserait moins face au dollar ou aux grands mouvements financiers.", sources: ["bdf"] },
      { title: "Une autonomie monétaire nationale ne serait pas gratuite.", text: " Une banque centrale française pourrait réduire ses taux pour soutenir l’activité. Mais si les investisseurs craignaient davantage d’inflation ou une baisse du franc, les importations pourraient devenir plus chères et les prêteurs pourraient demander un taux plus élevé. Une baisse du taux directeur ne garantirait donc pas à elle seule des emprunts publics ou privés moins coûteux.", sources: ["exchange-prices", "interest-risk", "state-rates"] },
      { title: "Une réponse commune lorsque le choc est commun.", text: " Si l’inflation augmente dans toute la zone, une banque centrale commune peut agir pour l’ensemble des pays et chercher à maintenir les anticipations de prix autour de son objectif. La France bénéficie alors d’une politique monétaire menée à l’échelle d’une grande monnaie ; rien ne garantit qu’une banque centrale nationale aurait systématiquement choisi de meilleurs taux.", sources: ["rates", "risk-sharing"] }
    ],
    reserve: [
      { title: "Un même taux peut convenir à la moyenne, mais pas à chaque pays.", text: " Si la croissance et l’inflation sont faibles en France mais fortes ailleurs, une hausse décidée pour la zone peut rendre inutilement les crédits français plus chers. Inversement, un taux trop bas pour un pays en forte croissance peut alimenter ses prix ou son endettement. De plus, à taux nominal identique, une inflation attendue plus faible correspond à un taux réel plus élevé.", sources: ["asymmetry", "real-rates"] },
      { title: "La même décision ne se transmet pas partout de la même façon.", text: " Une hausse atteint plus vite les ménages lorsque les prêts immobiliers sont souvent à taux variable. Elle peut arriver plus tard dans les pays, comme la France, où les taux sont davantage fixés pour plusieurs années. La structure des banques, des dettes et des crédits rend donc l’effet inégal entre pays, même lorsque le taux directeur est identique.", sources: ["mortgages"] },
      { title: "Impossible de faire baisser seulement la monnaie française.", text: " Avec un franc, une baisse de la monnaie pourrait rendre les produits français moins chers à l’étranger et soutenir certaines exportations. Dans l’euro, cet outil n’existe plus et d’autres ajustements peuvent être plus lents. Une dévaluation aurait toutefois aussi un coût : l’énergie, les matières premières et les autres produits importés deviendraient généralement plus chers.", sources: ["asymmetry", "exchange-prices"] },
    ...
    factors: [
      ...
      { title: "Inflation et cycle économique", text: "La monnaie commune fonctionne plus facilement si les pays connaissent des évolutions semblables des prix, des salaires et de la production. À taux nominal identique, une inflation attendue plus faible correspond aussi à un taux réel plus élevé.", sources: ["real-rates"] },
      { title: "Type de crédits", text: "Les prêts à taux variable transmettent rapidement une décision de la BCE ; les prêts à taux fixe la diffusent surtout lors d’un nouveau crédit ou d’un refinancement.", sources: ["mortgages"] },
      ...
      { title: "La comparaison avec les États-Unis", text: "La Réserve fédérale fixe elle aussi une politique monétaire commune : elle ne choisit pas un taux différent pour chaque État américain. En revanche, le budget fédéral et les marchés financiers américains amortissent davantage les crises propres à un État. Selon une synthèse de la BCE, le budget fédéral absorbe environ 10 à 20 % de ces chocs, alors que ce mécanisme reste beaucoup plus limité dans la zone euro. L’exemple américain montre donc à la fois qu’une banque centrale commune peut fonctionner sur un vaste territoire et qu’elle fonctionne plus facilement lorsqu’elle est accompagnée d’un partage budgétaire et financier important.", sources: ["fed", "risk-sharing"] },
      { title: "Ce qu’aurait donné le franc", text: "Une monnaie nationale permettrait d’adapter les taux et la valeur de la monnaie à la France. Elle pourrait aussi varier fortement, renchérir les importations ou conduire les prêteurs à demander davantage d’intérêts." , sources: ["exchange-prices", "interest-risk"] }
    ],
    decisionPrompt: "Votre réponse dépend du poids que vous accordez à la stabilité et aux échanges, par rapport à la liberté de fixer pour la France les taux et la valeur de la monnaie. Il faut notamment décider si le risque qu’un taux commun soit parfois mal adapté à la conjoncture française l’emporte sur les avantages d’une grande monnaie et d’une réponse commune aux chocs partagés. On ne peut pas attribuer à l’euro chaque réussite ou difficulté française.",
    sources: [
      ...
      { id: "rates", title: "We have cut interest rates. Why did we do it and what does that mean for you?", publisher: "Banque centrale européenne", year: "2024", url: "https://www.ecb.europa.eu/ecb-and-you/explainers/html/interest-rates-changes.en.html", note: "définition des taux directeurs et effets sur le crédit, l’épargne et l’inflation" },
      { id: "real-rates", title: "What are interest rates and what is the difference between nominal and real interest rates?", publisher: "Banque centrale européenne", year: "2016", url: "https://www.ecb.europa.eu/ecb-and-you/explainers/tell-me/html/nominal_and_real_interest_rates.en.html" },
      { id: "mortgages", title: "The transmission of monetary policy: from mortgage rates to consumption", publisher: "Banque centrale européenne — Bulletin économique", year: "2025", url: "https://www.ecb.europa.eu/press/economic-bulletin/articles/2025/html/ecb.ebart202504_01~b621c01098.en.html", note: "différences entre pays selon la structure des crédits immobiliers" },
      { id: "risk-sharing", title: "Risk sharing in the euro area: a focus on the public channel and the COVID-19 pandemic", publisher: "Banque centrale européenne — Bulletin économique", year: "2022", url: "https://www.ecb.europa.eu/press/economic-bulletin/articles/2022/html/ecb.ebart202207_01~f71f0eaa4a.en.html", note: "chocs communs, chocs propres à un pays et rôle des mécanismes d’ajustement" },
      { id: "state-rates", title: "Les taux d’intérêt négatifs", publisher: "Banque de France", year: "2025", url: "https://www.banque-france.fr/en/node/25837", note: "liens entre taux directeurs, crédit et financement des États" },
      { id: "fed", title: "The Fed Explained — Who We Are", publisher: "Réserve fédérale des États-Unis", year: "consulté en 2026", url: "https://www.federalreserve.gov/aboutthefed/fedexplained/who-we-are.htm", note: "une politique monétaire nationale commune aux États américains" },
      { id: "governing-council", title: "Governing Council", publisher: "Banque centrale européenne", year: "consulté en 2026", url: "https://www.ecb.europa.eu/ecb/decisions/govc/html/index.en.html", note: "composition et rôle du Conseil des gouverneurs" },
      { id: "exchange-prices", title: "Exchange rate pass-through into euro area inflation", publisher: "Banque centrale européenne — Bulletin économique", year: "2016", url: "https://www.ecb.europa.eu/press/economic-bulletin/html/eb201607.en.html", note: "effets d’une dépréciation monétaire sur les prix des importations et l’inflation" },
      { id: "interest-risk", title: "Ensemble, dialoguons : les taux d’intérêt", publisher: "Banque de France", year: "2025", url: "https://www.banque-france.fr/fr/ensemble-dialoguons/ensemble-dialoguons-les-taux-dinteret", note: "le taux demandé dépend notamment du risque perçu par le prêteur" }
    ]
  },
  ...
  50: {
    ...
    balance: [
      ...
      { text: "Carrefour illustre la question : le groupe a reçu d’importants allègements publics tout en réalisant des bénéfices et en rémunérant ses actionnaires. Comme tout l’argent entre dans la même trésorerie, on ne peut toutefois pas affirmer qu’un euro précis d’aide a payé un euro précis de dividende.", sources: ["senate", "carrefour"] }
    ],
    favour: [
      ...
      { title: "Au moins 211 milliards d’euros à contrôler, sans confondre aide et gaspillage.", text: " La commission d’enquête du Sénat estime qu’en 2023 les aides publiques aux entreprises représentaient au moins 211 milliards d’euros au sens large, dont 108 milliards selon un périmètre plus strict. Ces montants couvrent toutes les aides, pas seulement celles versées à des entreprises qui auraient pu s’en passer. Faute de suivi consolidé des bénéficiaires et des résultats, la part réellement inutile n’est pas chiffrable ; cette lacune renforce l’intérêt d’évaluer et de conditionner les aides.", sources: ["cost"] },
    ...
    sources: [
      ...
      { id: "cost", title: "Estimation du montant des aides publiques aux entreprises en 2023", publisher: "Sénat — commission d’enquête sur les aides publiques aux entreprises", year: "2025", url: "https://www.senat.fr/rap/r24-808-1/r24-808-18.html", note: "211 milliards d’euros au sens large et 108 milliards selon un périmètre plus strict" }
    ]
  },
  ...
  76: {
    ...
    reserve: [
      ...
      { title: "Des mutuelles d’entreprise parfois mieux adaptées au groupe.", text: " Une entreprise ou une branche peut choisir des garanties correspondant aux besoins moyens de ses salariés, avec une participation de l’employeur.", sources: ["collective", "employer"] },
