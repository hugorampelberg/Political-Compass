...
const RECONQUETE_RESEARCH_OVERRIDES_20260812 = {
  ...
  31: { confidence: 3, source: "https://www.budget2026.fr/" },
  32: { confidence: 3, source: "https://www.ericzemmour.fr/discours-saulieu" },
  33: { confidence: 1, source: "https://programme.ericzemmour.fr/pouvoir-achat" },
  34: { confidence: 2, source: "https://www.budget2026.fr/" },
  35: { confidence: 3, source: "https://www.ericzemmour.fr/discours-saulieu" },
  36: { confidence: 1, source: "https://programme.ericzemmour.fr/environnement" },
  37: { confidence: 3, source: "https://www.ericzemmour.fr/independance" },
  38: { confidence: 3, source: "https://www.ericzemmour.fr/independance" },
  39: { confidence: 2, source: "https://programme.ericzemmour.fr/europe" },
  ...
  44: { confidence: 1, source: "https://programme.ericzemmour.fr/impots" },
  46: { confidence: 1, source: "https://programme.ericzemmour.fr/outre-mer" },
  47: { confidence: 1, source: "https://programme.ericzemmour.fr/travail" },
  48: {
    confidence: 3,
  ...
  50: { confidence: 2, source: "https://programme.ericzemmour.fr/social" },
  51: { confidence: 1, source: "https://www.budget2026.fr/" },
  52: {
    response: 2,
    confidence: 3,
  ...
  53: { confidence: 3, source: "https://www.budget2026.fr/" },
  56: { confidence: 1, source: "https://programme.ericzemmour.fr/immigration" },
  60: { confidence: 3, source: "https://programme.ericzemmour.fr/securite" },
  61: { confidence: 3, source: "https://programme.ericzemmour.fr/liberte-expression" },
  63: {
    response: -2,
    confidence: 3,
  ...
  64: { confidence: 3, source: "https://programme.ericzemmour.fr/automobilistes" },
  65: { confidence: 3, source: "https://programme.ericzemmour.fr/nucleaire" },
  66: { confidence: 2, source: "https://www.budget2026.fr/" },
  67: { confidence: 3, source: "https://www.budget2026.fr/" },
  68: { confidence: 1, source: "https://programme.ericzemmour.fr/democratie" },
  69: {
    response: 2,
    confidence: 2,
  ...
  71: { confidence: 1, source: "https://programme.ericzemmour.fr/democratie" },
  72: {
    response: 0,
    confidence: 1,
  ...
  74: { confidence: 3, source: "https://programme.ericzemmour.fr/immigration" },
  76: {
    confidence: 2,
    source: "https://programme.ericzemmour.fr/sante"
  },
  77: { confidence: 1, source: "https://programme.ericzemmour.fr/sante" },
  78: {
    response: -2,
    confidence: 3,
  ...
  81: { confidence: 1, source: "https://programme.ericzemmour.fr/logement" },
  82: { confidence: 2, source: "https://www.ericzemmour.fr/discours-chambery" },
  83: { confidence: 3, source: "https://www.ericzemmour.fr/presentation-du-programme-defense" },
  84: { confidence: 3, source: "https://www.cnews.fr/france/2025-05-18/aide-mourir-cest-une-espece-de-retablissement-de-la-peine-de-mort-qui-ne-dit-pas" },
  85: {
    response: -1,
    confidence: 3,
  ...
  87: { confidence: 3, source: "https://fr.linkedin.com/posts/sarah-knafo-7a0129b5_interdiction-des-r%C3%A9seaux-sociaux-non-activity-7421824217454731264-dvlv" },
  88: {
    confidence: 3,
