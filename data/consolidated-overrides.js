...
(() => {
  ...
  const CONSOLIDATED_OVERRIDES =
  {
    ...
    "questionCount": 87,
    "entityCount": 21,
    "affectedQuestionCount": 87,
    "entityQuestionCount": 864,
    "questions": {
      "1": {
        "entities": {
          "lfi": {
          ...
          "rn": {
            "response": 1,
            "confidence": 2,
            "justification": "Accord modéré : RN privilégie la baisse des prélèvements sur le travail et le capital et accepte de rechercher en contrepartie des économies dans la dépense publique. L’orientation va dans ce sens mais reste partielle, conditionnelle ou moins ambitieuse que l’énoncé, d’où +1.",
            "source": "https://rassemblementnational.fr/documents/202406-programme.pdf"
          },
          "reconquete": {
            "response": 3,
            "confidence": 3,
            "justification": "Accord très fort : Reconquête privilégie la baisse des prélèvements sur le travail et le capital et accepte de rechercher en contrepartie des économies dans la dépense publique. Cette position reprend directement l’essentiel de l’arbitrage posé, ce qui justifie +3.",
      ...
      "2": {
        "entities": {
          ...
          "rn": {
            "response": 1,
            "confidence": 1,
            "justification": "Accord modéré : RN valorise le mérite, le travail, l’entrepreneuriat ou la prise de risque comme facteurs légitimes de réussite et accepte qu’ils puissent produire des écarts de revenus. L’orientation va dans ce sens mais reste partielle, conditionnelle ou moins ambitieuse que l’énoncé, d’où +1.",
            "source": "https://rassemblementnational.fr/documents/202406-programme.pdf"
          },
          "reconquete": {
            "response": 2,
      ...
      "3": {
        "entities": {
          ...
          "reconquete": {
            "response": -3,
            "confidence": 3,
            "justification": "Désaccord très fort : Reconquête privilégie la stabilité ou la baisse de la fiscalité sur les revenus élevés et le patrimoine plutôt qu’une hausse destinée à réduire les inégalités. Cette position est presque entièrement opposée à l’arbitrage posé, ce qui justifie -3.",
            "source": "https://www.budget2026.fr/"
          },
          "allemagne": {
            "response": 1,
      ...
      "4": {
        "entities": {
          ...
          "rn": {
            "response": -1,
            "confidence": 2,
            "justification": "Désaccord modéré : le RN ne défend pas de ratio légal général entre la rémunération du dirigeant et celle du salarié le moins payé. Il a toutefois proposé d'encadrer fortement certaines rémunérations excessives de cadres dirigeants, notamment les indemnités de départ, ce qui montre qu'il n'est pas opposé par principe à toute contrainte sur les rémunérations au sommet. Faute de proposition directement équivalente à un ratio salarial obligatoire, -1 est plus précis que -2.",
            "source": "https://www.assemblee-nationale.fr/dyn/17/amendements/0412/CION-SOC/AS8"
          },
          "reconquete": {
            "response": -3,
            "confidence": 1,
            "justification": "Désaccord très fort : Reconquête défend une ligne économique favorable à la liberté des entreprises et hostile aux contraintes supplémentaires sur les entreprises ; aucun soutien à un plafond légal des rémunérations n’est identifié.",
            "source": "https://www.budget2026.fr/"
          },
          "suisse": {
            "response": -3,
      ...
      "6": {
        "entities": {
          ...
          "rn": {
            "response": 0,
            "confidence": 1,
            "justification": "Position intermédiaire : RN combine un secteur privé important avec un rôle public central dans les services essentiels, sans affirmer la supériorité générale de l’un sur l’autre. La note 0 traduit cette combinaison plutôt qu’une absence artificielle de position.",
            "source": "https://rassemblementnational.fr/documents/202406-programme.pdf"
          },
          "reconquete": {
            "response": 2,
      ...
      "7": {
        "entities": {
          ...
          "rn": {
            "response": 1,
            "confidence": 3,
            "justification": "Accord modéré : le RN accepte qu'un État intervienne au capital d'une entreprise stratégique, mais sa position récente sur ArcelorMittal privilégie explicitement une action spécifique de type « golden share » plutôt qu'une nationalisation intégrale. Le parti reconnaît donc la légitimité d'une prise de contrôle ou d'influence publique stratégique, sans faire de la nationalisation temporaire ou durable son instrument privilégié ; +1 est plus précis que +2.",
            "source": "https://www.assemblee-nationale.fr/dyn/17/amendements/2872/AN/1"
          },
          "reconquete": {
            "response": 1,
            "confidence": 3,
      ...
      "8": {
        "entities": {
          ...
          "rn": {
            "response": 0,
            "confidence": 1,
            "justification": "Position intermédiaire : RN combine concurrence et réglementation sans donner clairement la priorité générale à l’une des deux méthodes. La note 0 traduit cette combinaison plutôt qu’une absence artificielle de position.",
            "source": "https://rassemblementnational.fr/documents/202406-programme.pdf"
          },
          "reconquete": {
            "response": 2,
            "confidence": 2,
            "justification": "Accord net : Reconquête mise prioritairement sur la concurrence, l’ouverture des marchés et la liberté d’entreprendre pour stimuler les prix, la qualité et l’innovation. L’orientation est nette, mais une partie de l’arbitrage ou son intensité reste plus nuancée que dans l’énoncé, d’où +2.",
            "source": "https://www.ericzemmour.fr/industrie"
          }
        }
      },
      "9": {
        "entities": {
          ...
          "rn": {
            "response": 1,
            "confidence": 2,
            "justification": "Accord modéré : RN considère la maîtrise de la dépense et le retour à l’équilibre budgétaire comme prioritaires et accepte de revoir certaines politiques sociales pour y parvenir. L’orientation va dans ce sens mais reste partielle, conditionnelle ou moins ambitieuse que l’énoncé, d’où +1.",
            "source": "https://questions.assemblee-nationale.fr/q17/17-888QG.htm"
          },
          "reconquete": {
            "response": 3,
            "confidence": 3,
            "justification": "Accord très fort : Reconquête considère la maîtrise de la dépense et le retour à l’équilibre budgétaire comme prioritaires et accepte de revoir certaines politiques sociales pour y parvenir. Cette position reprend directement l’essentiel de l’arbitrage posé, ce qui justifie +3.",
            "source": "https://www.budget2026.fr/"
          },
          "espagne": {
            "response": -2,
      ...
      "10": {
        "entities": {
          ...
          "reconquete": {
            ...
            "source": "https://programme.ericzemmour.fr/social"
          }
        }
      },
      "12": {
      ...
      "13": {
        "entities": {
          ...
          "rn": {
            "response": -1,
            "confidence": 2,
            "justification": "Désaccord modéré : le RN reste attaché à des systèmes collectifs obligatoires, notamment à la retraite par répartition, et n'envisage la capitalisation que comme un étage complémentaire. Il accepte donc certains compléments individuels ou collectifs, mais pas un basculement général vers une plus grande liberté de sortie des dispositifs publics obligatoires ; -1 est plus fidèle que 0.",
            "source": "https://questions.assemblee-nationale.fr/dyn/17/comptes-rendus/seance/session-ordinaire-de-2024-2025/deuxieme-seance-du-jeudi-31-octobre-2024"
          },
          "reconquete": {
            "response": 2,
            "confidence": 2,
      ...
      "14": {
        "entities": {
          ...
          "rn": {
            "response": -2,
            "confidence": 3,
            "justification": "Désaccord net : RN accorde une place importante aux normes familiales, culturelles ou morales traditionnelles et se montre réservé face à leur remise en cause rapide. Le désaccord est net, mais tous les termes de l’énoncé ne sont pas nécessairement rejetés avec la même intensité, d’où -2.",
            "source": "https://rassemblementnational.fr/documents/202406-programme.pdf"
          },
          "reconquete": {
            "response": -2,
            "confidence": 2,
            "justification": "Désaccord net : Reconquête accorde une place importante aux normes familiales, culturelles ou morales traditionnelles et se montre réservé face à leur remise en cause rapide. Le désaccord est net, mais tous les termes de l’énoncé ne sont pas nécessairement rejetés avec la même intensité, d’où -2.",
            "source": "https://www.ericzemmour.fr/discours-femmes-avec-zemmour"
          },
          "pays-bas": {
            "response": 3,
            "confidence": 3,
      ...
      "15": {
        "entities": {
          ...
          "reconquete": {
            "response": 0,
            "confidence": 1,
            "justification": "Position intermédiaire : Reconquête admet certains mécanismes de continuité budgétaire mais pas clairement l’adoption durable d’un nouveau budget sans vote parlementaire. La note 0 traduit cette combinaison plutôt qu’une absence artificielle de position.",
      ...
      "16": {
        "entities": {
          ...
          "rn": {
            "response": -2,
            "confidence": 1,
            "justification": "Désaccord net : RN privilégie l’égalité des chances et la liberté individuelle et refuse d’utiliser la restriction des libertés comme instrument général de réduction des écarts. Le désaccord est net, mais tous les termes de l’énoncé ne sont pas nécessairement rejetés avec la même intensité, d’où -2.",
            "source": "https://rassemblementnational.fr/documents/202406-programme.pdf"
          },
          "reconquete": {
            "response": -2,
            ...
            "source": "https://www.ericzemmour.fr/priorites"
          }
        }
      },
      "17": {
        "entities": {
          ...
          "pcf": {
            "response": 3,
            "confidence": 2,
            "justification": "Accord très fort : le PCF propose un plan d'action global contre les discriminations dans l'emploi, le logement, l'éducation et la santé, ainsi que des politiques spécifiques contre le racisme et les discriminations visant les personnes LGBTQI+. Il ne se limite donc pas à l'égalité juridique formelle et veut corriger activement les discriminations persistantes et structurelles ; +3 est justifié.",
            "source": "https://www.pcf.fr/pacte_2025_republique"
          },
          "ps": {
            "response": 3,
          ...
          "reconquete": {
            "response": -2,
            "confidence": 3,
            "justification": "Désaccord net : Reconquête privilégie l’égalité devant la loi et les mesures universalistes et se montre hostile aux politiques correctrices ciblant explicitement des groupes. Le désaccord est net, mais tous les termes de l’énoncé ne sont pas nécessairement rejetés avec la même intensité, d’où -2.",
            "source": "https://www.ericzemmour.fr/instruction"
          },
          "pays-bas": {
            "response": 3,
            "confidence": 3,
      ...
      "18": {
        "entities": {
          ...
          "rn": {
            "response": -2,
            "confidence": 3,
            "justification": "Désaccord net : RN privilégie l’uniformité des règles nationales et l’égalité territoriale et se méfie des dérogations régionales importantes. Le désaccord est net, mais tous les termes de l’énoncé ne sont pas nécessairement rejetés avec la même intensité, d’où -2.",
            "source": "https://rassemblementnational.fr/documents/202406-programme.pdf"
          },
          "reconquete": {
            "response": 0,
            ...
            "source": "https://programme.ericzemmour.fr/reforme-etat"
          }
        }
      },
      "19": {
      ...
      "27": {
        "entities": {
          ...
          "rn": {
            "response": 3,
            "confidence": 3,
            "justification": "Accord très fort : RN souhaite alourdir les peines effectivement exécutées et développer les capacités carcérales même si cela conduit à davantage d’incarcérations. Cette position reprend directement l’essentiel de l’arbitrage posé, ce qui justifie +3.",
            "source": "https://rassemblementnational.fr/livrets-thematiques"
          },
          "reconquete": {
            "response": 3,
            "confidence": 3,
            "justification": "Accord très fort : Reconquête souhaite alourdir les peines effectivement exécutées et développer les capacités carcérales même si cela conduit à davantage d’incarcérations. Cette position reprend directement l’essentiel de l’arbitrage posé, ce qui justifie +3.",
            "source": "https://programme.ericzemmour.fr/justice"
          },
          "royaume-uni": {
            "response": -1,
            "confidence": 3,
      ...
      "32": {
        "entities": {
          ...
          "pcf": {
            ...
            "source": "https://www.pcf.fr/canicule_chaleur_est_politique"
          },
          "les-ecologistes": {
            "response": 3,
            "confidence": 3,
          ...
          "reconquete": {
            "response": -2,
            "confidence": 3,
            "justification": "Désaccord net : Reconquête accepte la décarbonation lorsqu’elle repose sur le nucléaire, l’innovation et la technologie, mais la ligne économique portée par Sarah Knafo refuse les politiques climatiques qui réduisent la prospérité, la compétitivité ou le pouvoir d’achat. La question demande précisément de maintenir la priorité climatique même lorsqu’elle réduit la croissance à court terme ; cet arbitrage est nettement contraire à la doctrine du parti, d’où -2 plutôt que 0.",
            "source": "https://www.budget2026.fr/"
          },
          "espagne": {
            "response": 1,
      ...
      "33": {
        "entities": {
          ...
          "rn": {
            "response": -2,
            "confidence": 2,
            "justification": "Désaccord net : RN refuse une hausse importante du coût des carburants et énergies fossiles et privilégie technologie, offre énergétique ou baisse des taxes. Le désaccord est net, mais tous les termes de l’énoncé ne sont pas nécessairement rejetés avec la même intensité, d’où -2.",
            "source": "https://rassemblementnational.fr/conferences-de-presse/pouvoir-achat-conference-de-presse-de-marine-le-pen"
          },
          "reconquete": {
            "response": -2,
            "confidence": 3,
            "justification": "Désaccord net : Reconquête refuse une hausse importante du coût des carburants et énergies fossiles et privilégie technologie, offre énergétique ou baisse des taxes. Le désaccord est net, mais tous les termes de l’énoncé ne sont pas nécessairement rejetés avec la même intensité, d’où -2.",
            "source": "https://www.ericzemmour.fr/discours-saulieu"
          },
          "espagne": {
            "response": 1,
      ...
      "34": {
        "entities": {
          ...
          "rn": {
            "response": -1,
            "confidence": 1,
            "justification": "Désaccord modéré : RN refuse de financer des baisses de cotisations sociales par une hausse de la TVA en raison de son caractère régressif ou du risque pour le financement social. La réserve est réelle mais partielle ou insuffisamment générale pour retenir un désaccord plus fort, d’où -1.",
            "source": "https://rassemblementnational.fr/documents/202406-programme.pdf"
          },
          "reconquete": {
            "response": 0,
            "confidence": 1,
            "justification": "Position intermédiaire : Reconquête défend une baisse du coût du travail et des prélèvements, mais aucune proposition suffisamment précise de transfert vers la TVA n’a été retrouvée. Score neutre par prudence.",
            "source": "https://programme.ericzemmour.fr/pouvoir-achat"
          }
        }
      },
      "35": {
        "entities": {
          ...
          "reconquete": {
            "response": 1,
            "confidence": 2,
            "justification": "Accord modéré : Reconquête privilégie nettement l’innovation, la concurrence et les solutions technologiques plutôt qu’une écologie dominée par les interdictions. Mais le parti combat également plusieurs signaux-prix écologiques, notamment le malus automobile et diverses hausses de fiscalité énergétique, et ne fait donc pas de la taxe carbone un instrument privilégié. L’orientation vers le marché justifie +1, sans aller jusqu’à +2.",
            "source": "https://www.budget2026.fr/"
          }
        }
      },
      "36": {
        "entities": {
          ...
          "rn": {
            "response": -2,
            "confidence": 3,
            "justification": "Désaccord net : le RN combat plusieurs interdictions écologiques générales imposées aux consommateurs, notamment l'interdiction programmée de la vente de véhicules thermiques neufs à partir de 2035, et privilégie la neutralité technologique. Le parti n'exclut pas toute interdiction environnementale ciblée, mais refuse clairement que l'interdiction de produits demandés par les consommateurs devienne un instrument central de transition ; -2 est adapté.",
            "source": "https://www.assemblee-nationale.fr/dyn/17/amendements/0631/AN/53"
          },
          "reconquete": {
            "response": -3,
            "confidence": 3,
            "justification": "Désaccord très fort : Reconquête mène une opposition de principe aux interdictions écologiques qu’il juge punitives lorsqu’elles restreignent directement les choix de mobilité, de logement ou de consommation, notamment les ZFE. Le parti privilégie le nucléaire, l’innovation et la liberté de choix plutôt que l’interdiction de produits ou comportements encore demandés par les consommateurs. L’arbitrage central de la question est donc presque entièrement rejeté, ce qui justifie -3.",
            "source": "https://www.ericzemmour.fr/discours-saulieu"
          }
        }
      },
      "37": {
        "entities": {
          ...
          "rn": {
            "response": -2,
            "confidence": 2,
            "justification": "Désaccord net : RN refuse que les pays riches supportent une part prépondérante du coût mondial et insiste davantage sur la contribution de tous les grands émetteurs. Le désaccord est net, mais tous les termes de l’énoncé ne sont pas nécessairement rejetés avec la même intensité, d’où -2.",
            "source": "https://municipales2026.rassemblementnational.fr/communiques/le-rassemblement-national-offre-au-parlement-europeen-et-a-la-commission-le-mode-demploi-dune-veritable-preference-europeenne"
          },
          "allemagne": {
            "response": 1,
          ...
          "espagne": {
            ...
            "source": "https://www.lamoncloa.gob.es/Documents/2025/appendix-II-map-of-commitments-december.pdf"
          },
          "suisse": {
            "response": 0,
            "confidence": 2,
            ...
            "source": "https://www.bfs.admin.ch/bfs/en/home/statistics/cross-sectional-topics/monitoring-legislature-plan.html"
          },
          "finlande": {
            "response": 0,
            "confidence": 2,
          ...
          "royaume-uni": {
            ...
            "source": "https://www.gov.uk/government/publications/plan-for-change"
          },
          "danemark": {
            "response": 1,
            "confidence": 2,
            ...
            "source": "https://stm.dk/statsministeriet/publikationer/det-politiske-grundlag-for-firkloeverregeringen/?embed=true"
          },
          "pays-bas": {
            "response": 1,
            "confidence": 1,
          ...
          "pologne": {
            ...
            "source": "https://www.gov.pl/web/primeminister/poland-a-year-of-breakthrough---the-prime-minister-unveils-polands-2025-economic-plan"
          }
        }
      },
      "38": {
        "entities": {
          ...
          "rn": {
            "response": -2,
            "confidence": 2,
            "justification": "Désaccord net : RN refuse de nouveaux transferts de compétences et veut restituer ou préserver davantage de décisions au niveau national. Le désaccord est net, mais tous les termes de l’énoncé ne sont pas nécessairement rejetés avec la même intensité, d’où -2.",
            "source": "https://rassemblementnational.fr/documents/202406-programme.pdf"
          },
          "reconquete": {
            "response": -2,
            "confidence": 3,
            "justification": "Désaccord net : Reconquête refuse de nouveaux transferts de compétences et veut restituer ou préserver davantage de décisions au niveau national. Le désaccord est net, mais tous les termes de l’énoncé ne sont pas nécessairement rejetés avec la même intensité, d’où -2.",
            "source": "https://www.ericzemmour.fr/independance"
          }
        }
      },
      "39": {
        "entities": {
          ...
          "rn": {
            "response": 3,
            "confidence": 3,
            "justification": "Accord très fort : RN place la conservation de la capacité nationale de décision au-dessus d’un gain potentiel d’influence obtenu par davantage d’intégration européenne. Cette position reprend directement l’essentiel de l’arbitrage posé, ce qui justifie +3.",
            "source": "https://rassemblementnational.fr/documents/202406-programme.pdf"
          },
          "reconquete": {
            "response": 3,
            "confidence": 3,
            "justification": "Accord très fort : Reconquête place la conservation de la capacité nationale de décision au-dessus d’un gain potentiel d’influence obtenu par davantage d’intégration européenne. Cette position reprend directement l’essentiel de l’arbitrage posé, ce qui justifie +3.",
            "source": "https://www.ericzemmour.fr/independance"
          }
        }
      },
      "40": {
        "entities": {
          ...
          "rn": {
            "response": 0,
            "confidence": 1,
            "justification": "Position intermédiaire : le RN ne défend plus la sortie de l'euro et inscrit désormais son action économique dans le cadre de la monnaie unique. En revanche, cette acceptation du cadre existant ne suffit pas à établir que le parti juge le bilan économique global de l'euro positivement malgré la perte d'autonomie monétaire nationale. Faute d'un arbitrage récent et explicite sur cette formulation précise, 0 est plus prudent que +1.",
            "source": "https://rassemblementnational.fr/documents/202406-programme.pdf"
          },
          "reconquete": {
            "response": -1,
            "confidence": 2,
            "justification": "Désaccord modéré : Éric Zemmour considère que l’entrée dans l’euro était une mauvaise décision et a longtemps critiqué la monnaie unique pour ses effets sur la compétitivité et les déséquilibres entre économies européennes. Il juge néanmoins qu’en sortir aujourd’hui serait encore pire et ne propose plus d’abandonner l’euro. Le bilan qu’il en fait reste donc plutôt négatif, mais son pragmatisme sur le maintien de la monnaie commune limite le désaccord à -1.",
            "source": "https://programme.ericzemmour.fr/europe"
          },
          "suisse": {
            "response": -3,
            "confidence": 1,
      ...
      "41": {
        "entities": {
          ...
          "rn": {
            "response": -2,
            "confidence": 2,
            "justification": "Désaccord net : RN veut limiter le pouvoir normatif européen et redonner davantage de latitude réglementaire aux États membres. Le désaccord est net, mais tous les termes de l’énoncé ne sont pas nécessairement rejetés avec la même intensité, d’où -2.",
            "source": "https://municipales2026.rassemblementnational.fr/communiques/opinion-minoritaire-sur-le-rapport-relatif-au-bouclier-democratique-europeen-euds"
          },
          "reconquete": {
            "response": -2,
            "confidence": 3,
            "justification": "Désaccord net : Reconquête veut limiter le pouvoir normatif européen et redonner davantage de latitude réglementaire aux États membres. Le désaccord est net, mais tous les termes de l’énoncé ne sont pas nécessairement rejetés avec la même intensité, d’où -2.",
            "source": "https://www.ericzemmour.fr/independance"
          },
          "finlande": {
            "response": 0,
      ...
      "42": {
        "entities": {
          ...
          "rn": {
            "response": 3,
            "confidence": 3,
            "justification": "Accord très fort : RN accepte qu’un gouvernement national écarte certaines règles européennes lorsque celles-ci entrent directement en conflit avec des priorités nationales majeures. Cette position reprend directement l’essentiel de l’arbitrage posé, ce qui justifie +3.",
            "source": "https://rassemblementnational.fr/documents/202406-programme.pdf"
          },
          "reconquete": {
            "response": 3,
            "confidence": 3,
            "justification": "Accord très fort : Reconquête accepte qu’un gouvernement national écarte certaines règles européennes lorsque celles-ci entrent directement en conflit avec des priorités nationales majeures. Cette position reprend directement l’essentiel de l’arbitrage posé, ce qui justifie +3.",
            "source": "https://www.ericzemmour.fr/independance"
          }
        }
      },
      "43": {
        "entities": {
          ...
          "rn": {
            "response": 2,
            "confidence": 3,
            "justification": "Accord net : le RN propose de remplacer l'IFI par un impôt sur la fortune financière afin de sortir l'immobilier de l'assiette patrimoniale spécifique et de concentrer la taxation sur certains actifs financiers. Cela va directement dans le sens d'une suppression de l'IFI immobilier, mais le RN ne rejette pas pour autant le principe d'un impôt sur la fortune puisqu'il en crée un autre en remplacement ; +2 est donc plus précis que +3.",
      ...
      "44": {
        "entities": {
          ...
          "rn": {
            "response": -3,
            "confidence": 3,
            "justification": "Désaccord très fort : le groupe RN a proposé d'aller jusqu'à l'exonération totale de droits de donation ou de succession pour certaines transmissions d'entreprises familiales sous condition de conservation longue. Cette orientation vise explicitement à réduire fortement la fiscalité des transmissions importantes, à l'opposé d'une taxation accrue des héritages élevés ; -3 est justifié.",
            "source": "https://www.assemblee-nationale.fr/dyn/17/amendements/AMANR5L17PO59048B1341P0D1N000001"
          },
          "reconquete": {
            "response": -3,
            "confidence": 3,
      ...
      "45": {
        "entities": {
          ...
          "rn": {
            ...
            "source": "https://francaisdeletranger.rassemblementnational.fr/"
          },
          "reconquete": {
            "response": -2,
            "confidence": 1,
            "justification": "Désaccord net : Reconquête s'oppose à l'extension extraterritoriale durable de l'impôt français et défend une baisse de la fiscalité du capital ; la question va dans le sens inverse, sans preuve suffisante pour retenir -3.",
            "source": "https://programme.ericzemmour.fr/impots"
          },
          "espagne": {
            "response": -3,
      ...
      "46": {
        "entities": {
          ...
          "ps": {
            "response": -1,
            "confidence": 2,
            "justification": "Désaccord modéré : le PS veut encadrer strictement les sanctions de France Travail, interdire les radiations pour refus d'emplois précaires ou inadaptés et garantir un recours avant sanction. Il maintient néanmoins explicitement un barème national de sanctions et ne supprime donc pas toute conséquence en cas de manquements répétés. Face au cas plus restrictif décrit par la question — plusieurs refus d'emplois raisonnablement adaptés — le désaccord existe mais reste modéré ; -1 est adapté.",
            "source": "https://projet-socialiste.fr/projet/vivre-libres/"
          },
          "modem": {
            "response": 1,
      ...
      "47": {
        "question": {
          ...
          "explanation": "Faire ses courses dans les DOM-TOM coûte en moyenne 30 % à 40 % plus cher pour l'alimentation par rapport à la France hexagonale, notamment à cause du coût d'acheminement dû l'éloignement géographique. "
        },
        "entities": {
          "lfi": {
            "response": 2,
      ...
      "48": {
        "entities": {
          ...
          "rn": {
            "response": -1,
            "confidence": 1,
            "justification": "Désaccord modéré : RN considère la protection du contrat permanent comme nécessaire et refuse de la réduire au motif qu’elle pénaliserait les personnes hors de l’emploi stable. La réserve est réelle mais partielle ou insuffisamment générale pour retenir un désaccord plus fort, d’où -1.",
            "source": "https://rassemblementnational.fr/documents/202406-programme.pdf"
          },
          "reconquete": {
            "response": 2,
            ...
            "source": "https://programme.ericzemmour.fr/travail"
          },
          "pologne": {
            "response": -2,
            "confidence": 1,
      ...
      "49": {
        "entities": {
          ...
          "rn": {
            "response": 1,
            "confidence": 2,
            "justification": "Accord modéré : des responsables RN ont explicitement ouvert la réflexion à une part de capitalisation collective en complément des retraites. Le parti maintient cependant la répartition comme socle et ne porte pas à ce stade un système mixte généralisé dans lequel la capitalisation constituerait un pilier structurel comparable à celui décrit par la question ; +1 est donc plus précis que 0 comme que +2.",
            "source": "https://questions.assemblee-nationale.fr/dyn/17/comptes-rendus/seance/session-ordinaire-de-2024-2025/deuxieme-seance-du-jeudi-31-octobre-2024"
          },
          "reconquete": {
            "response": 2,
      ...
      "51": {
        "entities": {
          ...
          "rn": {
            "response": 2,
            "confidence": 2,
            "justification": "Accord net : RN lie fortement certaines prestations à la durée d’activité, de cotisation ou à des obligations de participation au marché du travail. L’orientation est nette, mais une partie de l’arbitrage ou son intensité reste plus nuancée que dans l’énoncé, d’où +2.",
            "source": "https://rassemblementnational.fr/documents/202406-programme.pdf"
          },
          "reconquete": {
            "response": 2,
            "confidence": 2,
            "justification": "Accord net : Reconquête lie fortement certaines prestations à la durée d’activité, de cotisation ou à des obligations de participation au marché du travail. L’orientation est nette, mais une partie de l’arbitrage ou son intensité reste plus nuancée que dans l’énoncé, d’où +2.",
            "source": "https://programme.ericzemmour.fr/social"
          }
        }
      },
      "53": {
        "entities": {
          ...
          "rn": {
            "response": 1,
            "confidence": 2,
            "justification": "Accord modéré : le RN a proposé de davantage taxer les superdividendes et les rachats d'actions et accepte donc de limiter certains versements aux actionnaires lorsqu'ils sont jugés excessifs. En revanche, aucune proposition retrouvée ne conditionne directement dividendes, rachats d'actions ou rémunérations dirigeantes au remboursement préalable d'une aide publique exceptionnelle. L'orientation va dans le sens de la question sans reprendre son mécanisme exact, d'où +1.",
            "source": "https://www.assemblee-nationale.fr/dyn/17/amendements/1906A/AN/788"
          },
          "reconquete": {
            "response": 0,
            "confidence": 1,
            "justification": "Position intermédiaire : Reconquête accepte certaines contreparties aux aides publiques sans règle claire comparable au blocage prévu par l’énoncé. La note 0 traduit cette combinaison plutôt qu’une absence artificielle de position.",
            "source": "https://www.budget2026.fr/"
          }
        }
      },
      "54": {
        "entities": {
          ...
          "rn": {
            "response": 2,
            "confidence": 3,
            "justification": "Accord net : dans le dossier ArcelorMittal, le RN a proposé qu'une action spécifique détenue par l'État lui confère des droits d'opposition sur les décisions touchant les intérêts essentiels de la Nation. Cette utilisation ciblée de l'État actionnaire correspond clairement à l'idée d'orienter une entreprise stratégique sur le long terme, sans démontrer une volonté générale d'étendre ce mode de pilotage à toutes les grandes entreprises françaises ; +2 reste adapté.",
            "source": "https://www.assemblee-nationale.fr/dyn/17/amendements/2872/AN/1"
          },
          "reconquete": {
            "response": 2,
      ...
      "55": {
        "entities": {
          ...
          "reconquete": {
            "response": 3,
            "confidence": 3,
            "justification": "Accord très fort : Reconquête veut réduire fortement les contraintes administratives imposées aux entreprises et accepte que certaines règles sociales ou environnementales soient simplifiées ou allégées. Cette position reprend directement l’essentiel de l’arbitrage posé, ce qui justifie +3.",
            "source": "https://www.budget2026.fr/"
          },
          "allemagne": {
            "response": 1,
      ...
      "58": {
        "entities": {
          ...
          "rn": {
            "response": 1,
            "confidence": 1,
            "justification": "Accord modéré : le RN veut réduire fortement l'immigration économique et mieux la sélectionner selon les besoins nationaux. Il existe donc une orientation en faveur d'une immigration plus choisie, mais le parti ne formule pas une doctrine suffisamment nette consistant à privilégier systématiquement les immigrés hautement qualifiés au détriment des profils peu qualifiés ; le score +1 est conservé avec une confiance basse.",
            "source": "https://rassemblementnational.fr/documents/202406-programme.pdf"
          },
          "finlande": {
            "response": 2,
      ...
      "63": {
        "entities": {
          ...
          "rn": {
            "response": 3,
            "confidence": 3,
            "justification": "Accord très fort : RN autorise des mesures de surveillance préventive ciblées contre des personnes présentant un risque sérieux pour la sécurité même avant qu’une infraction puisse être poursuivie. Cette position reprend directement l’essentiel de l’arbitrage posé, ce qui justifie +3.",
            "source": "https://www.assemblee-nationale.fr/dyn/17/scrutins/7405"
          },
          "reconquete": {
            "response": 3,
            "confidence": 3,
            "justification": "Accord très fort : Reconquête autorise des mesures de surveillance préventive ciblées contre des personnes présentant un risque sérieux pour la sécurité même avant qu’une infraction puisse être poursuivie. Cette position reprend directement l’essentiel de l’arbitrage posé, ce qui justifie +3.",
            "source": "https://programme.ericzemmour.fr/securite"
          },
          "allemagne": {
            "response": 3,
            "confidence": 2,
      ...
      "64": {
        "entities": {
          ...
          "reconquete": {
            "response": 3,
            "confidence": 3,
            "justification": "Accord très fort : Reconquête défend une conception large de la liberté d’expression qui protège aussi les propos choquants, blasphématoires ou profondément offensants tant qu’ils restent licites. Cette position reprend directement l’essentiel de l’arbitrage posé, ce qui justifie +3.",
            "source": "https://programme.ericzemmour.fr/liberte-expression"
          },
          "allemagne": {
            "response": 2,
            "confidence": 2,
      ...
      "68": {
        "entities": {
          ...
          "rn": {
            "response": -3,
            "confidence": 3,
            "justification": "Désaccord très fort : RN refuse une interdiction programmée des ventes de voitures thermiques et privilégie la neutralité technologique ou le choix du consommateur. Cette position est presque entièrement opposée à l’arbitrage posé, ce qui justifie -3.",
            "source": "https://www.assemblee-nationale.fr/dyn/17/amendements/0631/AN/53"
          },
          "reconquete": {
            "response": -3,
            "confidence": 3,
            "justification": "Désaccord très fort : Reconquête refuse une interdiction programmée des ventes de voitures thermiques et privilégie la neutralité technologique ou le choix du consommateur. Cette position est presque entièrement opposée à l’arbitrage posé, ce qui justifie -3.",
            "source": "https://programme.ericzemmour.fr/automobilistes"
          },
          "allemagne": {
            "response": -2,
            "confidence": 2,
      ...
      "69": {
        "entities": {
          ...
          "rn": {
            "response": 3,
            "confidence": 3,
            "justification": "Accord très fort : RN place le nucléaire au cœur du mix énergétique et accepte qu’il capte une part d’investissement qui ne sera alors pas consacrée aux renouvelables. Cette position reprend directement l’essentiel de l’arbitrage posé, ce qui justifie +3.",
            "source": "https://www.assemblee-nationale.fr/dyn/17/scrutins/2522"
          },
          "reconquete": {
            "response": 3,
            "confidence": 3,
            "justification": "Accord très fort : Reconquête place le nucléaire au cœur du mix énergétique et accepte qu’il capte une part d’investissement qui ne sera alors pas consacrée aux renouvelables. Cette position reprend directement l’essentiel de l’arbitrage posé, ce qui justifie +3.",
            "source": "https://programme.ericzemmour.fr/nucleaire"
          },
          "allemagne": {
            "response": -3,
            "confidence": 2,
      ...
      "71": {
        "entities": {
          ...
          "pays-bas": {
            ...
            "source": "https://www.government.nl/site/binaries/site-content/collections/documents/2026/02/23/2026-2030-coalition-agreement-lets-get-to-work---building-a-better-netherlands/2026-2030-coalition-agreement-let%E2%80%99s-get-to-work-building-a-better-netherlands.pdf"
          },
          "pologne": {
            "response": -2,
            "confidence": 3,
      ...
      "72": {
        "entities": {
          ...
          "rn": {
            "response": -1,
            "confidence": 1,
            "justification": "Désaccord modéré : RN privilégie la responsabilité des élus et le contrôle démocratique et se méfie d’un transfert supplémentaire de pouvoir décisionnel aux experts non élus. La réserve est réelle mais partielle ou insuffisamment générale pour retenir un désaccord plus fort, d’où -1.",
            "source": "https://rassemblementnational.fr/documents/202406-programme.pdf"
          },
          "reconquete": {
            "response": -2,
            "confidence": 3,
            "justification": "Désaccord net : Reconquête oppose régulièrement la souveraineté populaire et la responsabilité politique à la technocratie et veut supprimer ou réduire fortement plusieurs agences et organismes administratifs. Les experts peuvent éclairer la décision, mais le parti ne défend pas qu’ils disposent de davantage de pouvoir sur les choix économiques que les responsables élus ; la proposition va donc nettement à rebours de sa doctrine, d’où -2.",
            "source": "https://www.budget2026.fr/"
          },
          "royaume-uni": {
            "response": 1,
      ...
      "73": {
        "entities": {
          ...
          "rn": {
            "response": 0,
            "confidence": 1,
            "justification": "Position intermédiaire : RN accepte la responsabilité de gouverner malgré l’impopularité mais insiste aussi sur la concertation ou la légitimité démocratique. La note 0 traduit cette combinaison plutôt qu’une absence artificielle de position.",
            "source": "https://rassemblementnational.fr/documents/202406-programme.pdf"
          },
          "royaume-uni": {
            "response": 1,
      ...
      "74": {
        "entities": {
          ...
          "pcf": {
            "response": 2,
            "confidence": 2,
            "justification": "Accord net : le PCF veut instaurer de nouveaux pouvoirs citoyens, notamment un référendum d'initiative populaire et un droit de pétition, ce qui traduit une volonté claire d'accroître le recours à la démocratie directe. Il associe toutefois ces mécanismes à des conférences citoyennes et à la co-élaboration des lois afin d'éclairer et préparer les décisions complexes. Il soutient donc fortement davantage de référendums, sans assumer aussi directement l'idée de faire voter sans précaution sur des sujets techniques mal maîtrisés ; +2 est adapté.",
            "source": "https://www.pcf.fr/pacte_2025_republique"
          },
          "les-ecologistes": {
            "response": 2,
          ...
          "rn": {
            "response": 2,
            "confidence": 3,
            "justification": "Accord net : le RN veut élargir fortement le recours au référendum et, en février 2026, une députée RN a défendu en commission un référendum d'initiative populaire en matière législative. Cette volonté de démocratie référendaire est directe. En revanche, rien ne montre que le parti assume spécifiquement la contrepartie ajoutée par la question consistant à faire trancher sans réserve des sujets très techniques mal compris par les citoyens ; +2 est donc plus précis que +3.",
            "source": "https://www.assemblee-nationale.fr/dyn/17/amendements/2081/CION_LOIS/CL7"
          },
          "reconquete": {
            "response": 2,
            "confidence": 2,
      ...
      "76": {
        "entities": {
          ...
          "rn": {
            "response": 2,
            "confidence": 1,
            "justification": "Accord net : RN veut renforcer la capacité d’action de l’exécutif ou du chef de l’État face aux blocages parlementaires. L’orientation est nette, mais une partie de l’arbitrage ou son intensité reste plus nuancée que dans l’énoncé, d’où +2.",
            "source": "https://rassemblementnational.fr/documents/202406-programme.pdf"
          },
          "allemagne": {
            "response": -3,
      ...
      "77": {
        "entities": {
          ...
          "rn": {
            "response": 2,
            "confidence": 2,
            "justification": "Accord net : RN soutient un système électoral entièrement ou très largement proportionnel et accepte le recours plus fréquent aux coalitions comme conséquence. L’orientation est nette, mais une partie de l’arbitrage ou son intensité reste plus nuancée que dans l’énoncé, d’où +2.",
            "source": "https://rassemblementnational.fr/documents/202406-programme.pdf"
          },
          "reconquete": {
            "response": 0,
      ...
      "79": {
        "entities": {
          ...
          "rn": {
            "response": -2,
            "confidence": 2,
            "justification": "Désaccord net : RN accorde un poids autonome important aux normes culturelles, à l’assimilation ou aux valeurs d’origine pour expliquer certains écarts de délinquance. Le désaccord est net, mais tous les termes de l’énoncé ne sont pas nécessairement rejetés avec la même intensité, d’où -2.",
            "source": "https://rassemblementnational.fr/livrets-thematiques"
          },
          "reconquete": {
            "response": -3,
            "confidence": 3,
            "justification": "Désaccord très fort : Reconquête accorde un poids autonome important aux normes culturelles, à l’assimilation ou aux valeurs d’origine pour expliquer certains écarts de délinquance. Cette position est presque entièrement opposée à l’arbitrage posé, ce qui justifie -3.",
      ...
      "81": {
        "entities": {
          ...
          "rn": {
            ...
            "source": "https://www.assemblee-nationale.fr/dyn/17/scrutins/1214"
          },
          "reconquete": {
            "response": -2,
            "confidence": 2,
            "justification": "Désaccord net : Reconquête défend la liberté d’installation des médecins et refuse de conditionner le conventionnement à la densité médicale locale. Le désaccord est net, mais tous les termes de l’énoncé ne sont pas nécessairement rejetés avec la même intensité, d’où -2.",
      ...
      "82": {
        "entities": {
          ...
          "rn": {
            "response": -1,
            "confidence": 2,
            "justification": "Désaccord modéré : RN maintient un rôle substantiel aux assurances ou complémentaires privées et refuse de transférer l’essentiel de leur champ vers l’assurance publique. La réserve est réelle mais partielle ou insuffisamment générale pour retenir un désaccord plus fort, d’où -1.",
            "source": "https://rassemblementnational.fr/documents/202406-programme.pdf"
          },
          "reconquete": {
            "response": -2,
            "confidence": 1,
            "justification": "Désaccord net : Reconquête maintient un rôle substantiel aux assurances ou complémentaires privées et refuse de transférer l’essentiel de leur champ vers l’assurance publique. Le désaccord est net, mais tous les termes de l’énoncé ne sont pas nécessairement rejetés avec la même intensité, d’où -2.",
            "source": "https://programme.ericzemmour.fr/sante"
          },
          "suisse": {
            "response": -2,
      ...
      "83": {
        "entities": {
          ...
          "rn": {
            "response": -2,
            "confidence": 3,
            "justification": "Désaccord net : plusieurs députés RN ont demandé le maintien des petites maternités et des services hospitaliers de proximité, en soulignant les risques d'une concentration qui allonge les trajets et accentue la désertification médicale. Le parti privilégie donc nettement le maillage territorial plutôt qu'une politique générale de fermeture ou fusion des petites structures. Des regroupements médicalement indispensables restent possibles, ce qui justifie -2 plutôt que -3.",
            "source": "https://questions.assemblee-nationale.fr/q17/17-195QOSD.htm"
          },
          "reconquete": {
            "response": -2,
            "confidence": 3,
      ...
      "84": {
        "entities": {
          ...
          "rn": {
            "response": 1,
            "confidence": 1,
            "justification": "Accord modéré : RN veut donner aux chefs d’établissement une autonomie réelle dans le recrutement d’une partie des enseignants ou dans leur évaluation. L’orientation va dans ce sens mais reste partielle, conditionnelle ou moins ambitieuse que l’énoncé, d’où +1.",
            "source": "https://rassemblementnational.fr/documents/202406-programme.pdf"
          },
          "reconquete": {
            "response": 0,
      ...
      "86": {
        "entities": {
          ...
          "reconquete": {
            "response": -2,
            "confidence": 1,
            "justification": "Désaccord net : Reconquête défend le droit des propriétaires à louer leurs résidences secondaires et refuse de donner aux communes un pouvoir d’interdiction aussi étendu. Le désaccord est net, mais tous les termes de l’énoncé ne sont pas nécessairement rejetés avec la même intensité, d’où -2.",
            "source": "https://programme.ericzemmour.fr/logement"
          },
          "suisse": {
            "response": 1,
            "confidence": 1,
      ...
      "87": {
        "entities": {
          ...
          "ps": {
            "response": 2,
            "confidence": 3,
            "justification": "Accord net : le PS soutient la poursuite d'une aide militaire, financière et politique importante à l'Ukraine, veut utiliser les avoirs russes gelés pour l'aide et la reconstruction et cherche à placer l'Ukraine en position de force. Son objectif reste toutefois une paix juste et durable obtenue par une issue politique, plutôt qu'un engagement formulé comme automatiquement maintenu jusqu'à la récupération de chaque territoire quel que soit le temps nécessaire ; +2 est donc plus précis que +3.",
            "source": "https://projet-socialiste.fr/projet/pacifier-le-monde/"
          },
          "reconquete": {
            "response": -2,
            "confidence": 2,
            "justification": "Désaccord net : Éric Zemmour affirme que la guerre en Ukraine n’est pas la guerre de la France et privilégie une issue négociée rapide. Cette ligne est incompatible avec l’engagement à maintenir durablement une aide militaire et financière importante aussi longtemps que des territoires ukrainiens restent occupés, même si la guerre se prolonge. Reconquête ne demande toutefois pas nécessairement la suppression immédiate de toute aide, ce qui justifie -2 plutôt que -3.",
            "source": "https://www.ericzemmour.fr/discours-chambery"
          }
        }
      },
      "88": {
        "entities": {
          ...
          "reconquete": {
            "response": -2,
            "confidence": 3,
            "justification": "Désaccord net : Éric Zemmour défend une dissuasion nucléaire strictement indépendante, placée au service des intérêts vitaux français, et se montre hostile à son européanisation. La question préserve toutefois à la France seule la décision finale d’emploi de l’arme, ce qui maintient l’élément central de souveraineté qu’il défend. L’opposition à l’extension de la garantie aux partenaires européens reste forte mais n’est donc pas maximale, d’où -2.",
            "source": "https://www.ericzemmour.fr/presentation-du-programme-defense"
          },
          "espagne": {
            "response": -3,
      ...
      "89": {
        "entities": {
          ...
          "rn": {
            "response": -3,
            "confidence": 3,
            "justification": "Désaccord très fort : lors du vote définitif du 15 juillet 2026 sur le droit à l'aide à mourir, la très grande majorité des députés RN ayant voté s'est prononcée contre. Une minorité interne a voté pour, mais la position parlementaire du groupe est massivement opposée au dispositif décrit ; -3 reste donc adapté.",
            "source": "https://www.assemblee-nationale.fr/dyn/17/scrutins/8280"
          },
          "reconquete": {
            "response": -3,
            "confidence": 3,
            "justification": "Désaccord très fort : Reconquête refuse l’euthanasie ou le suicide assisté même dans le cadre strict décrit et privilégie exclusivement les soins palliatifs. Cette position est presque entièrement opposée à l’arbitrage posé, ce qui justifie -3.",
            "source": "https://www.cnews.fr/france/2025-05-18/aide-mourir-cest-une-espece-de-retablissement-de-la-peine-de-mort-qui-ne-dit-pas"
          },
          "danemark": {
            "response": 0,
            "confidence": 1,
      ...
      "90": {
        "entities": {
          ...
          "rn": {
            ...
            "source": "https://questions.assemblee-nationale.fr/q17/17-8276QE.htm"
          },
          "reconquete": {
            "response": -1,
            "confidence": 3,
      ...
      "91": {
        "entities": {
          ...
          "rn": {
            "response": 3,
            "confidence": 3,
            "justification": "Accord très fort : RN défend le caractère universel des allocations familiales en fonction du nombre d’enfants et refuse leur diminution avec le revenu. Cette position reprend directement l’essentiel de l’arbitrage posé, ce qui justifie +3.",
            "source": "https://questions.assemblee-nationale.fr/q17/17-13606QE.htm"
          },
          "reconquete": {
            "response": 3,
            "confidence": 3,
      ...
      "92": {
        "entities": {
          ...
          "rn": {
            "response": 2,
            "confidence": 2,
            "justification": "Accord net : lors de la première lecture de janvier 2026, les députés RN participant aux principaux scrutins ont soutenu l'article instaurant l'interdiction d'accès aux réseaux sociaux avant 15 ans. Le vote final de juillet a toutefois montré une position moins unanime, avec des abstentions et quelques votes contre au sein du groupe. L'orientation favorable est donc nette sans être suffisamment homogène pour +3, d'où +2.",
            "source": "https://www.assemblee-nationale.fr/dyn/17/scrutins/5167"
          },
          "reconquete": {
            "response": -2,
            "confidence": 3,
            "justification": "Désaccord net : Sarah Knafo s’oppose explicitement à une interdiction étatique générale des réseaux sociaux avant 15 ans et estime que cette décision doit relever de l’autorité parentale. Elle invoque aussi les risques de surveillance liés à la vérification généralisée de l’âge. Cette opposition directe justifie -2 ; la note n’est pas portée à -3 car Reconquête reconnaît le problème posé par les réseaux sociaux aux mineurs et souhaite que les parents puissent eux-mêmes les interdire.",
            "source": "https://fr.linkedin.com/posts/sarah-knafo-7a0129b5_interdiction-des-r%C3%A9seaux-sociaux-non-activity-7421824217454731264-dvlv"
          },
          "allemagne": {
            "response": 1,
            "confidence": 3,
      ...
      "93": {
        "entities": {
          ...
          "rn": {
            "response": 1,
            "confidence": 2,
            "justification": "Accord modéré : des députés RN demandent que les données sensibles des citoyens, entreprises, armées et services publics soient hébergées en France ou dans l'Union européenne et dénoncent la dépendance aux fournisseurs soumis à des législations extraterritoriales. Cette préférence souveraine s'étend logiquement aux infrastructures d'IA publiques. Le RN ne dit toutefois pas qu'il faudrait accepter sans limite une solution européenne sensiblement moins performante ou plus coûteuse ; +1 est donc adapté.",
            "source": "https://questions.assemblee-nationale.fr/q17/17-2583QE.htm"
          },
          "reconquete": {
            "response": 1,
            "confidence": 3,
            "justification": "Accord modéré : le rapport de Sarah Knafo au Parlement européen fait de la souveraineté technologique une priorité, demande de réduire la dépendance aux fournisseurs non européens dans le cloud et l’IA et soutient l’usage de la commande publique pour favoriser des solutions européennes. Le même rapport insiste cependant fortement sur la compétitivité, la qualité et la concurrence ; il n’accepte pas explicitement une dégradation importante de performance ou un surcoût. +1 est donc plus adapté que la note négative actuelle.",
  ...
  const questionIndexes = new Map(
    DATA.questions.map((question, index) => [question.id, index])
  );
  const entitiesById = new Map(DATA.entities.map(entity => [entity.id, entity]));
  const touchedEntities = new Set();

  Object.entries(CONSOLIDATED_OVERRIDES.questions).forEach(([questionId, override]) => {
    const questionIndex = questionIndexes.get(Number(questionId));
    if (questionIndex === undefined) return;

    if (override.question) {
      DATA.questions[questionIndex] = {
        ...override.question,
        coefficients: { ...override.question.coefficients }
      };
    }

    Object.entries(override.entities || {}).forEach(([entityId, entityOverride]) => {
      const entity = entitiesById.get(entityId);
      if (!entity) return;

      entity.responses[questionIndex] = entityOverride.response;
      entity.confidence[questionIndex] = entityOverride.confidence;
      entity.justifications[questionIndex] = entityOverride.justification;
      entity.sources[questionIndex] = entityOverride.source;
  ...
  touchedEntities.forEach(entity => {
    entity.axisScores = Object.fromEntries(DATA.axes.map(axis => {
      ...
      const numerator = DATA.questions.reduce(
        (sum, question, index) =>
          sum + (entity.responses[index] ?? 0) * (question.coefficients[axis.key] || 0),
        0
      );
