...
const MODEM_OVERRIDES = {
  ...
  "55": {
    "justification": "Position intermédiaire : le MoDem accepte certaines conditions de résidence, de régularité et d'intégration pour l'accès à certains droits, mais ne défend pas une exclusion générale des immigrés légaux de la protection sociale pendant leurs premières années. La proposition précise de Q55 n'est ni pleinement soutenue ni totalement rejetée ; 0 reste adapté.",
    "source": "https://www.mouvementdemocrate.fr/actualites/francois-bayrou-le-droit-dasile-que-nous-defendons-est-completement-devoye-video-6608"
  },
  "56": {
  ...
  "71": {
    "response": -2,
    "justification": "Désaccord net : la tradition démocrate privilégie la proportionnelle, le compromis et la responsabilisation du Parlement. Le soutien ponctuel à des mécanismes permettant d'adopter un budget ne signifie pas une volonté de renforcer durablement le président contre le Parlement ; Q71 va au contraire contre cette culture institutionnelle, d'où -2.",
    "source": "https://www.mouvementdemocrate.fr/programme/democratie-et-citoyennete-2424"
  },
  "73": {
    "justification": "Accord très fort : François Bayrou relie explicitement la régularité et la durée du séjour à des efforts de travail, de maîtrise du français et d'acceptation des principes communs. Ces exigences correspondent directement à la logique d'intégration concrète décrite par Q73 ; +3 reste justifié.",
    "source": "https://www.mouvementdemocrate.fr/actualites/francois-bayrou-notre-desordre-politique-rend-la-france-faible-video-7531-video"
  },
  "74": {
  ...
  "79": {
    "justification": "Désaccord net : François Bayrou s'est explicitement opposé au recrutement des enseignants par les chefs d'établissement et ne souhaite pas transformer ces derniers en employeurs locaux disposant d'un fort pouvoir hiérarchique. Cette opposition directe à l'instrument décrit par Q79 justifie -2.",
  ...
  "86": {
    "response": 3,
    "justification": "Accord très fort : Anne Bergantz défend explicitement des allocations familiales pleinement universelles, sans modulation liée aux revenus des parents et ouvertes dès le premier enfant. La proposition correspond directement à Q86 ; +3 est pleinement justifié.",
