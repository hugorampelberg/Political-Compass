...
export default async function handler(req, res) {
  ...
  try {
    ...
    const message = error?.message === "GEMINI_API_KEY_NOT_CONFIGURED"
      ...
      : "L’analyse Gemini n’a pas pu être générée. Le modèle subit actuellement une forte demande. Vos réponses sont sont enregistrées et vous pourrez rééssayer plus tard l'analyse Gemini sans recommencer le quizz.";
